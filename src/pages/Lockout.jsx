...
const Lockout = () => {
  return (
      <div className=" lg:bg-[url('/images/lockoutRedbg.png')] bg-gradient-to-b from-[#8B2828] to-[#322020] lg:bg-cover  lg:h-screen  bg-no-repeat bg-center ">
      <div className=" ">
      <LockoutNav />
      <div className="lg:hidden">
        <img src="/images/lockoutlogo.png" alt="" />
      </div>
      <div className="text-white flex justify-center lg:pt-80 lg:mt-80 lg:mb-20 lg:p-0 p-24">
          <a
