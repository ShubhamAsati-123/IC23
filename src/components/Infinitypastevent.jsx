      ...
      <div className="flex justify-center">
        <div className="flex flex-col mt-10 w-11/12 lg:w-2/3">
          <div className="border border-1 h-28 m-4 flex items-center justify-between  px-5 lg:px-10 rounded-lg">
            ...
            <a href="https://www.codechef.com/START65?utm_source=codeforces_blog&utm_medium=organic&utm_campaign=START65">
          ...
          <div className="border border-1 h-28 m-4 flex items-center justify-between px-5 lg:px-10 rounded-lg">
            <a href="https://www.codechef.com/INFI2021">
          ...
          <div className="border border-1 h-28 m-4 flex items-center justify-between  px-5 lg:px-10 rounded-lg">
            ...
            <a href="https://www.codechef.com/INFY20">
          ...
          <div className="border border-1 h-28 m-4 flex items-center justify-between  px-5 lg:px-10 rounded-lg">
            <a href="https://www.codechef.com/INFY2019">
